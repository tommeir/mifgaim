...
?><div class="faq-category-group">
  ...
  <?php if (count($nodes)): ?>
    <?php foreach ($nodes as $i => $node): ?>
	  ...
	  <?php print '<a href="/faq#data-'.$node['nid'].'"><h3 id="data-'.$node['nid'].'">' . strip_tags($node['question']) . '</h3></a>'; ?>
      <?php //print $node['question']; ?>
      </div> <!-- Close div: faq-question faq-dt-hide-answer -->

      <div class="faq-answer faq-dd-hide-answer" id="<?php print 'answer-data-'.$node['nid']; ?>" style="display: none;">
      <?php print $node['body']; ?>
