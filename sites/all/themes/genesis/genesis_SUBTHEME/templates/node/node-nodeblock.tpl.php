...
<div id="<?php print $node_id; ?>" class="<?php print $classes; ?>">
  <div class="node-inner">
    ...
    <div class="node-content"><?php print $content; ?>
	  <?php 
	    if ($node->field_link_block[0]['value']) { 
	      print l(t('Read more'), $node->field_link_block[0]['value'],array('attributes' => array('class' => 'readmore', 'title'=>$node->title, 'alt'=>$node->title)));
	    }
	  ?>
	</div>
    <?php if ($terms): ?>
